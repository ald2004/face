<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column prop="image" label="住户">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="picbox=true">查看住户</el-button>
          <el-dialog :visible.sync="picbox" title='查看住户' width="700px">
      ...
      <el-table-column label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <edit v-if="checkPermission(['ACCESSCONTROL_ALL','ACCESSCONTROL_EDIT','ADMIN'])" :data="scope.row" :roles="roles" :sup_this="sup_this"/>
          <el-button v-else disabled size="mini" type="success">编辑</el-button>          
          <el-popover
            v-if="checkPermission(['ACCESSCONTROL_ALL','ACCESSCONTROL_DELETE','ADMIN'])"
...
import user from './module/homeuser'
export default {
  components: { eHeader, edit,user },
  mixins: [initData],
  data() {
    return {
